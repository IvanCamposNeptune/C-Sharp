...
using Libreria_CDLC; //Para usar el data set

namespace CDLC_V1
{
    public partial class ConsultarTec : Consultas
    {
        public ConsultarTec()
        {
            InitializeComponent();
        ...
        private void ConsultarTec_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Buscar_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txt_Folio.Text.Trim()) == false)//Si no esta vacio entonces...
            {
                try
                {
                    ...
                    string cmd = "Select * FROM Tecnico WHERE folio_equipo LIKE ('%" + txt_Folio.Text.Trim() + "%') "; //Instruccion SQL para mostrar todo de la tabla donde el folio del cliente se parezca a lo que tiene el TextBox
