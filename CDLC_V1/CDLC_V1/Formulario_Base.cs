...
namespace CDLC_V1
{
    public partial class Formulario_Base : Form
    {
        ...
        public virtual void EliminarReporte()
        {
        ...
        public virtual Boolean GuardarReporte()
        {

            return false;
        }

        public virtual Boolean GuardarContacto()
        {

            return false;
        }

        public virtual Boolean ActualizaEstadoTec()
        {

            return false;
        }

        public virtual Boolean ActualizaEstadoAdmi()
        {
